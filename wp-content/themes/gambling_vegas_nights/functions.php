...
$themename = "VegasAllNightLong";
$shortname = "art";
$default_footer_content = "<a href='#'>Контакты</a> | <a href='#'>Правила использования</a> | <a href='#'>Торговая марка</a> | <a href='#'>Приватность</a><br/> &copy; 2010 ".get_bloginfo('name').". Все права защищены.";
$options = array (
                array(  "name" => "HTML",
